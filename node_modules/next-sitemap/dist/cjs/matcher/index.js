...
exports.escapeStringRegexp = (text) => {
...
const makeRegexp = (pattern, options = {}) => {
    options = Object.assign({ caseSensitive: false }, options);
    ...
    pattern = exports.escapeStringRegexp(pattern).replace(/\\\*/g, '[\\s\\S]*');
...
exports.matcher = (inputs, patterns, options = {}) => {
    return baseMatcher(inputs, patterns, options, false);
};
exports.isMatch = (inputs, patterns, options = {}) => {
