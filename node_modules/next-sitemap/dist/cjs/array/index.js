...
exports.toChunks = (arr, chunkSize) => {
 ...
 */
exports.removeFromArray = (inputArr, toRemoveArr) => {
 ...
 * @param toRemoveArr array of elements to be removed
 */
exports.removeIfMatchPattern = (inputArr, toRemoveArr) => {
    const matchedArr = matcher_1.matcher(inputArr, toRemoveArr);
    return exports.removeFromArray(inputArr, matchedArr);
};
