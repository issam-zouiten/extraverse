...
exports.resolveSitemapChunks = (baseSitemapPath, chunks, config) => {
...
exports.getRuntimePaths = (config) => {
    return {
        ...
        ROUTES_MANIFEST: exports.getPath(config.sourceDir, 'routes-manifest.json'),
        EXPORT_MARKER: exports.getPath(config.sourceDir, 'export-marker.json'),
        SITEMAP_FILE: exports.getPath(config.outDir, `${config.sitemapBaseFileName}.xml`),
